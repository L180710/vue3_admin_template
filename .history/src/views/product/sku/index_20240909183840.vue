  ...
  <el-table border style="margin: 10px 0" :data="skuArr">
    ...
    <el-table-column label="操作" width="250px" fixed="right">
      <template #="{ row, $index }">
        ...
        <el-popconfirm :title="`您确定删除${row.skuName}?`" width="200px" @confirm="removeSku(row.id)">
          <template #reference>
  ...
  <el-drawer v-model="drawer">
    ...
    <template #default>
      ...
      <el-row style="margin-bottom:15px">
        ...
        <el-col :span="18">
          <el-tag style="margin: 0 5px 5px 0" v-for="item in skuInfo.skuAttrValueList" :key="item.id">{{
      ...
      <el-row style="margin-bottom:15px">
        ...
        <el-col :span="18">
          <el-tag style="margin: 0 5px 5px 0" v-for="item in skuInfo.skuSaleAttrValueList" :key="item.id">{{
        ...
        <el-col :span="18">
          <el-carousel :interval="4000" type="card" height="200px">
            <el-carousel-item v-for="item in skuInfo.skuImageList" :key="item.id">
              <img :src="item.imgUrl" style="width:100%;height:100%;object-fit:contain" alt="图片" />
            </el-carousel-item>
          </el-carousel>
        </el-col>
      </el-row>
