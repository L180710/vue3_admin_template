      ...
      <el-table border style="margin: 10px 0" :data="saleAttr">
        ...
        <el-table-column label="销售属性值">
          ...
          <template #="{ row, $index }">
            ...
            <el-input v-if="row.flag == true" placeholder="请你输入属性值" size="small" style="width:100px"></el-input>
            <el-button @click="toEdit" v-else type="primary" size="small" icon="Plus"></el-button>
          </template>
        </el-table-column>
